...
namespace Platform.Data
{
        ...
        where TConstants : LinksConstants<TLinkAddress>
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        void Delete(IList<TLinkAddress> restriction); // TODO: Возможно стоит возвращать удалённую связь, если удаление было реально выполнено, и Constants.Null, если нет.
