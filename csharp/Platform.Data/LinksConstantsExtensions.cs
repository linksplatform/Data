...
namespace Platform.Data
{
    ...
    public static class LinksConstantsExtensions
    {
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsReference<TLinkAddress>(this ILinksConstants<TLinkAddress> linksConstants, TLinkAddress address) => linksConstants.IsInternalReference(address) || linksConstants.IsExternalReference(address);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsInternalReference<TLinkAddress>(this ILinksConstants<TLinkAddress> linksConstants, TLinkAddress address) => linksConstants.InternalReferencesRange.Contains(address);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsExternalReference<TLinkAddress>(this ILinksConstants<TLinkAddress> linksConstants, TLinkAddress address) => linksConstants.ExternalReferencesRange?.Contains(address) ?? false;
    }
}
